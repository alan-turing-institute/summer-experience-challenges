...
With the above information, you should be able to have a go at decrypting these texts:

**TODO** JavaScript block.
Essentially: the reverse of the first block, where the cipher text is preselected from one of a few examples, and then you can key in the decryption letter by letter to reveal the plain text.
There should also be a plot showing the distribution of the letters.
The plain text should have '?' in places where the decoding is not yet known.
