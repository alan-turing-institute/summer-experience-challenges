...
Specifically, if you were an attacker and you knew the public key (i.e. $e$ and $n$), it's still extremely difficult to find the correct value of $d$ to correctly decode the message.
