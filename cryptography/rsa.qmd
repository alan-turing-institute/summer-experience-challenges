...
The RSA scheme revolves around modular arithmetic, which we touched briefly on yesterday.
...
1. The *encoding* step involves the sender taking the message $m$ and raising it to a power $e$ (for 'encryption'), modulo $n$:
...
For example, if you were an attacker and you knew the public key (i.e. $e$ and $n$), it's still extremely difficult to find the correct value of $d$ to correctly decode the message.
...
Try this out using the interactive form here:
...
- **Step 4**: Choose $m$ (message: can be anything!)
<div class="rsa-grid-1">
<div id="rsa-m-in">
...
<script type="module">
{{< include rsa_encode.js >}}
</script>


**TODO:** Another page on proving why this works (using Fermat's little theorem), in case there are very advanced students who are bored by this point.
